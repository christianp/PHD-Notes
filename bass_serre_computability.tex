...
Variable substitution can also be dealt with systematically, by composing with the projection function $P_i^i$ everywhere except the position which will take the substituted value:
