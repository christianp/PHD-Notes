...
\begin{lemma}
	Let $A = \{a_0, a_1, \dots\} \subseteq \NN$ be a monotonically increasing integer sequence. Define a function $\sigma_A : \NN \to A$ such that $\sigma_A(n) = a_n$.
...
Next we define a function to decide membership of the set of factorial numbers, $\{d!, d \in \NN\}$. \recur{
