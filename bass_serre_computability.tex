...
Grzegorczyk \cite{Grzegorczyk_1953} introduced a hierarchy of classes of recursive functions delineated by the number of times unbounded recursion is used in the construction of their members. Cannonito \cite{Cannonito_1966b} defined a notion of computability for groups in the context of this hierarchy. Cannonito and Gatterdam \cite{Cannonito_1972} \cite{Gatterdam_1973} showed that taking the free product with amalgamation or an HNN extension of group(s) at a particular level of the hierarchy creates a group which is computable at most one level higher.
...
The main result of this paper is that the fundamental group of a graph of \grz{n} groups is \grz{n+1}-computable. We also define computability for Stallings' pregroups \cite{Stallings_1971} in the context of the Grzegorczyk hierarchy.
